!function(e, t) {
          ...
          , o = function() {
            ...
            t = function() {
                ...
                if (!(e < s))
                    ...
                    case 3:
                        t[0] = (0,
                        n.getTimestamp)() + " ERROR:",
                        console.error.apply(console, t);
                        break;
                    default:
                        return t[0] = (0,
                        n.getTimestamp)() + " DEFAULT:",
    ...
    , function(e, t, i) {
        ...
        function o() {
            return (0,
            u.default)().replace(/-/g, "").toUpperCase()
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }),
        ...
        var r = i(3)
          ...
          , l = function() {
            var e = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection
              ...
              , n = !!e && !!t && !!i
              , o = !1;
            return d.default.debug(a.getBrowserInfo(), "isAPISupport:" + n),
            a.isChrome() && a.getBrowserVersion() >= 58 && "iOS" !== a.getBrowserOS() && (o = !0),
            a.isFireFox() && a.getBrowserVersion() >= 56 && (o = !0),
            a.isOpera() && a.getBrowserVersion() >= 45 && (o = !0),
            a.isSafari() && a.getBrowserVersion() >= 11 && (o = !0),
            a.isSupportedPC() || a.isSupportedMobile() || (o = !1),
            n && o
        }
          , p = function() {
            var e = arguments[0];
          ...
          , m = function(e) {
            ...
            this.getAudioLevel = function() {
                ...
                return d.default.warning("can't find analyser in audioLevelHelper"),
                0
            }
            ,
            this
          ...
          , v = function(e, t, i) {
            try {
                ...
                n.setAttribute("style", "width:1px;high:1px;"),
                document.body.appendChild(n),
                n.addEventListener("playing", function(e) {
                    a.isFireFox() ? n.videoWidth && (t(n.videoWidth, n.videoHeight),
                    document.body.removeChild(n)) : (t(n.videoWidth, n.videoHeight),
        ...
        t.checkSystemRequirements = l,
        t.generateSessionId = o,
        t.audioLevelHelper = m,
        t.CSCrashRecord = g,
        t.vsResHack = v,
        t.safeCall = p
    }
    , function(e, t, i) {
        ...
        var n = function() {
            ...
            e.removeEventListener = function(t, i) {
                var n;
                -1 !== (n = e.dispatcher.eventListeners[t].indexOf(i)) && e.dispatcher.eventListeners[t].splice(n, 1)
            }
            ,
    ...
    , function(e, t, i) {
        ...
        var n = function() {
          ...
          , f = function() {
            ...
            "Chrome" === i[1] && null != (e = t.match(/(mqqbrowser(?=\/))\/?(\d+)/i)) && (i = e),
            "Chrome" === i[1] && null != (e = t.match(/(micromessenger(?=\/))\/?(\d+)/i)) && (i = e),
    ...
    , function(e, t, i) {
        ...
        t.GIT_VERSION = "release_20180109_01-13-gd621e4f",
        t.VERSION = "2.1.0",
        t.WEBCS_DOMAIN = n,
    ...
    , function(e, t, i) {
        ...
        i(12))
          ...
          , d = function() {
            ...
            return e.list = {},
            e.url = (0,
            a.shouldUseHttps)() ? "https://" + o.EVENT_REPORT_DOMAIN + ":6443/events/report" : "http://" + o.EVENT_REPORT_DOMAIN + ":6080/events/report",
            e.urlBackup = (0,
            a.shouldUseHttps)() ? "https://" + o.EVENT_REPORT_BACKUP_DOMAIN + ":6443/events/report" : "http://" + o.EVENT_REPORT_BACKUP_DOMAIN + '":6080/events/report',
            ...
            e.send = function(t) {
                try {
                    (0,
                    a.post)(e.url, t, null, function(i) {
                        (0,
                        a.post)(e.urlBackup, t, null, function(e) {}, {
                            timeout: 1e4
                        })
                    }, {
                        timeout: 1e4
        ...
        : function(e) {
          ...
          , S = function(e) {
            ...
            r.setVideoFrameRate = function(t) {
                return !(0,
                f.isFireFox)() && ("object" === (void 0 === t ? "undefined" : o(t)) && t instanceof Array && t.length > 1 && (e.attributes = e.attributes || {},
            ...
            r.setVideoBitRate = function(t) {
                return "object" === (void 0 === t ? "undefined" : o(t)) && t instanceof Array && t.length > 1 && (e.attributes = e.attributes || {},
            ...
            r.init = function(n, a) {
                ...
                if (void 0 === s && (s = 2),
                !0 === r.initialized)
                    return void ("function" == typeof a && a({
                        type: "warning",
                    ...
                    if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                        ...
                        if (e.screen)
                            ...
                            if (!t()) {
                                var l = 30
                                  , m = 30;
                                void 0 !== e.attributes.minFrameRate && (l = e.attributes.minFrameRate),
                        ...
                        if ((0,
                        c.GetUserMedia)(v, function(t) {
                            p.default.debug("User has granted access to local media"),
                            r.dispatchEvent({
                                type: "accessAllowed"
                            }),
                            r.stream = t,
                            ...
                            e.screen && (0,
                            f.isChrome)() && r.stream && r.stream.getVideoTracks()[0] && (r.stream.getVideoTracks()[0].onended = function() {
                                r.dispatchEvent({
                            ...
                            p.default.error("Media access:", t.msg),
                        ...
                        e.screen && e.audio) {
                            ...
                            p.default.debug(S),
                            (0,
                            c.GetUserMedia)(S, function(e) {
                                p.default.info("User has granted access to auxiliary local media."),
                                r.dispatchEvent({
                                    type: "accessAllowed"
                                }),
                                r.aux_stream = e
            ...
            ,
            r.close = function() {
                if (p.default.debug("Close stream with id", e.streamID),
                void 0 !== r.stream) {
                    var t = r.stream.getTracks();
                    for (var i in t)
                        t.hasOwnProperty(i) && t[i].stop();
                    r.stream = void 0
                }
                r.initialized = !1,
            ...
            r.enableAudio = function() {
                return p.default.debug("Enable audio stream with id", e.streamID),
                !(!r.hasAudio() || !r.initialized || void 0 === r.stream || !0 === r.stream.getAudioTracks()[0].enabled) && (void 0 !== r.unmuteAudio && r.unmuteAudio(),
                r.audioEnabled = !0,
            ...
            r.disableAudio = function() {
                return p.default.debug("Disable audio stream with id", e.streamID),
                !!(r.hasAudio() && r.initialized && void 0 !== r.stream && r.stream.getAudioTracks()[0].enabled) && (void 0 !== r.muteAudio && r.muteAudio(),
                r.audioEnabled = !1,
                r.stream.getAudioTracks()[0].enabled = !1,
                r.sid && v.report.audioSendingStopped(r.sid, {
                    succ: !0,
                    reason: "muteAudio"
                }),
                !0)
            ...
            r.enableVideo = function() {
                return p.default.debug("Enable video stream with id", e.streamID),
                !(!r.initialized || void 0 === r.stream || !r.stream.getVideoTracks().length || !0 === r.stream.getVideoTracks()[0].enabled) && (void 0 !== r.unmuteVideo && r.unmuteVideo(),
                r.videoEnabled = !0,
            ...
            r.disableVideo = function() {
                return p.default.debug("Disable video stream with id", e.streamID),
                !!(r.initialized && void 0 !== r.stream && r.stream.getVideoTracks().length && r.stream.getVideoTracks()[0].enabled) && (void 0 !== r.muteVideo && r.muteVideo(),
                r.videoEnabled = !1,
                r.stream.getVideoTracks()[0].enabled = !1,
                r.lowStream && r.lowStream.disableVideo(),
                r.sid && v.report.videoSendingStopped(r.sid, {
                    succ: !0,
                    reason: "muteVideo"
                }),
                !0)
            ...
            r.play = function(e, t) {
                r.showing = !1,
                !r.local || r.video || r.screen ? void 0 !== e && (r.player = new a.default({
                    id: r.getId(),
                    stream: r,
                    elementID: e,
                    options: void 0,
            ...
            ,
            r.stop = function() {
                p.default.debug("Stop stream player with id", e.streamID),
            ...
            r.getStats = function(e) {
                r.pc && r.pc.getStats ? r.pc.getStats(function(t) {
                    if (r.pc.isSubscriber) {
                        var i = (0,
                        m.subscribeStatsFilter)(t);
                        (0,
                        f.isFireFox)() && (i.videoReceivedResolutionHeight = r.videoHeight + "",
                        i.videoReceivedResolutionWidth = r.videoWidth + ""),
                        e && e((0,
                        m.subscribeStatsFilter)(t))
                    } else {
                        var i = (0,
                        m.publishStatsFilter)(t);
                        (0,
                        f.isChrome)() || (i.videoSendResolutionHeight = r.videoHeight + "",
                        i.videoSendResolutionWidth = r.videoWidth + ""),
                        !(0,
                        f.isChrome)() && r.uplinkStats && (i.videoSendBandwidth = r.uplinkStats.uplink_available_bandwidth + "",
            ...
            r.getAudioLevel = function() {
                return r.audioLevelHelper ? r.audioLevelHelper.getAudioLevel() : r.stream ? 0 !== r.stream.getAudioTracks().length ? (r.audioLevelHelper = new g.audioLevelHelper(r.stream),
                r.audioLevelHelper.getAudioLevel()) : void p.default.warning("can't get audioLevel beacuse no audio trace in stream") : (p.default.warning("can't get audioLevel beacuse no stream exist"),
                0)
            }
            ,
            r
          ...
          , _ = function(e) {
            return p.default.debug("Create stream with id", e.streamID),
            S(e)
        }
          , h = function(e, t) {
            navigator.mediaDevices && navigator.mediaDevices.enumerateDevices || (p.default.warning("enumerateDevices() not supported."),
    ...
    , function(e, t, i) {
        ...
        var o = i(5)
          ...
          , d = function(e) {
            var t, i, n = (0,
            r.default)({});
            return n.elementID = e.elementID,
            n.id = e.id,
            n.url = e.url,
            n.div = document.createElement("div"),
            n.div.setAttribute("id", "bar_" + n.id),
            n.bar = document.createElement("div"),
            n.bar.setAttribute("style", "width: 100%; height: 15%; max-height: 30px; position: absolute; bottom: 0; right: 0; background-color: rgba(255,255,255,0.62)"),
            n.bar.setAttribute("id", "subbar_" + n.id),
            n.link = document.createElement("a"),
            n.link.setAttribute("href", "http://www.lynckia.com/"),
            n.link.setAttribute("target", "_blank"),
            n.logo = document.createElement("img"),
            n.logo.setAttribute("style", "width: 100%; height: 100%; max-width: 30px; position: absolute; top: 0; left: 2px;"),
            n.logo.setAttribute("alt", "Lynckia"),
            i = function(e) {
                "block" !== e ? e = "none" : clearTimeout(t),
                n.div.setAttribute("style", "width: 100%; height: 100%; position: absolute; bottom: 0; right: 0; display:" + e)
            }
            ,
            n.display = function() {
                i("block")
            ...
            ,
            document.getElementById(n.elementID).appendChild(n.div),
            n.div.appendChild(n.bar),
            e.stream.screen || void 0 !== e.options && void 0 !== e.options.speaker && !0 !== e.options.speaker || (n.speaker = new s.default({
          ...
          , _ = function(e, t, i) {
            ...
            e.screen)
                ...
                null !== window.navigator.userAgent.match("Firefox")) {
                    var n = {};
                    void 0 != e.video.mandatory ? (n.video = e.video,
                    n.video.mediaSource = "window") : n = {
                        video: {
                            mediaSource: "window"
                        }
                    },
        ...
        i(12))
          ...
          , p = function(e, t, i, n) {
            ...
            c.post)(e, r, function(r) {
                ...
                n("Get server node failed [" + s + "]", e)) : i(a, e)
            }, function(e, i) {
          ...
          , f = function(e, t, i) {
            ...
            for (var a = function(i, r) {
                o ? u.report.joinChooseServer(e.sid, {
                    lts: n,
                    succ: !0,
                    csAddr: r,
                ...
                t(i),
                u.report.joinChooseServer(e.sid, {
                    lts: n,
                    succ: !0,
                    csAddr: r,
                    serverList: i.gateway_addr,
                ...
                var g;
                g = (0,
                c.shouldUseHttps)() ? "https://" + f[m] + ":5668/getwebgw/jsonp" : "http://" + f[m] + ":5669/getwebgw/jsonp",
                p(g, e, a, d)
            }
            var v = setTimeout(function() {
                if (!o)
                    for (var t = r.WEBCS_DOMAIN_BACKUP_LIST, i = 0; i < t.length; ++i) {
                        var n;
                        n = (0,
                        c.shouldUseHttps)() ? "https://" + t[i] + ":5668/getwebgw/jsonp" : "http://" + t[i] + ":5669/getwebgw/jsonp",
                        p(n, e, a, d)
                    }
            }, 1e3);
            setTimeout(function() {
          ...
          , m = function(e, t, i) {
            var n = !1
              ...
              , r = 1;
            !function a() {
                if (l.CSCrashRecord.shouldBlock())
                    return s.default.warning("CS connetion crash too many times in 10s"),
                    i && i();
                n || f(e, function(e) {
                    n = !0,
                    clearTimeout(o),
        ...
        i(18))
          ...
          , p = function(e) {
            ...
            t.resize = function() {
                ...
                e.stream.screen ? .75 * i < n ? (t.video.style.width = i + "px",
                t.video.style.height = .75 * i + "px",
                t.video.style.top = -(.75 * i / 2 - n / 2) + "px",
                t.video.style.left = "0px") : (t.video.style.height = n + "px",
                t.video.style.width = 4 / 3 * n + "px",
                t.video.style.left = -(4 / 3 * n / 2 - i / 2) + "px",
                t.video.style.top = "0px") : i === t.containerWidth && n === t.containerHeight || (.75 * i > n ? (t.video.style.width = i + "px",
                t.video.style.height = .75 * i + "px",
                t.video.style.top = -(.75 * i / 2 - n / 2) + "px",
                t.video.style.left = "0px") : (t.video.style.height = n + "px",
                t.video.style.width = 4 / 3 * n + "px",
            ...
            t.video.addEventListener("playing", function(e) {
                !function e() {
                    if (t.video.videoWidth * t.video.videoHeight > 4)
                        return void u.default.debug("video dimensions:", t.video.videoWidth, t.video.videoHeight);
                    setTimeout(e, 50)
                }()
            }),
            t.containerWidth = 0,
            t.containerHeight = 0,
            t.resizer = new d.default(t.container,t.resize),
            t.resize(),
            (0,
            l.attachMediaStream)(document.getElementById("video" + t.id), e.stream.stream),
            (0,
            l.attachMediaStream)(document.getElementById("audio" + t.id), e.stream.stream),
            t
        };
        t.default = p
    }
    , function(e, t, i) {
        ...
        var n = i(5)
          ...
          , r = function(e) {
            ...
            ) : (r.picker = document.createElement("input"),
            r.picker.setAttribute("id", "picker_" + r.id),
            r.picker.type = "range",
            r.picker.min = 0,
            r.picker.max = 100,
            r.picker.step = 10,
            r.picker.value = a,
            r.picker.setAttribute("orient", "vertical"),
            r.div.appendChild(r.picker),
            r.media.volume = r.picker.value / 100,
            r.media.muted = !1,
            r.picker.oninput = function() {
                r.picker.value > 0 ? (r.media.muted = !1,
                r.icon.setAttribute("src", r.url + "/assets/sound48.png")) : (r.media.muted = !0,
                r.icon.setAttribute("src", r.url + "/assets/mute48.png")),
                r.media.volume = r.picker.value / 100
            }
            ,
    ...
    , function(e, t, i) {
        ...
        !function(r, a) {
            ...
            return i.detach = function(t, i) {
                e(t, function(e) {
                    e.resizedAttached && "function" == typeof i && (e.resizedAttached.remove(i),
    ...
    , function(e, t, i) {
        ...
        "undefined" != typeof window && window.navigator)
            if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
                if (l.log("This appears to be Firefox"),
                d = "firefox",
                        ...
                        for (var i = [], n = 0; n < e.iceServers.length; n++) {
                            ...
                            if (o.hasOwnProperty("urls"))
                                for (var r = 0; r < o.urls.length; r++) {
                                    ...
                                    0 === o.urls[r].indexOf("turn") && (a.username = o.username,
                ...
                r = function(e, t, i) {
                    ...
                    return c < 38 && (l.log("spec: " + JSON.stringify(e)),
                    ...
                    return Object.keys(e).forEach(function(i) {
                        if ("require" !== i && "advanced" !== i && "mediaSource" !== i) {
                            ...
                            if (void 0 !== n.ideal) {
                                ...
                                var a = {};
                                "number" == typeof n.ideal ? (a[r("min", i)] = n.ideal,
                                t.optional.push(a),
                                a = {},
                                a[r("max", i)] = n.ideal,
                                t.optional.push(a)) : (a[r("", i)] = n.ideal,
                                t.optional.push(a))
                            }
                ...
                if (r = function(e, t, i) {
                    return e.audio && (e.audio = f(e.audio)),
                ...
                navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (l.log("This appears to be Edge"),
                d = "edge",
                c = l.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2),
                u = 12) : l.log("Browser does not appear to be WebRTC-capable");
        else
            l.log("This does not appear to be a browser"),
            d = "not a browser";
        var g = {};
        try {
    ...
    , function(e, t, i) {
        ...
        var o = i(5)
          ...
          , l = function(e) {
            ...
            if (n.id = e.id,
            n.url = e.url,
            n.stream = e.stream.stream,
            n.elementID = e.elementID,
            n.audio = document.createElement("audio"),
            n.audio.setAttribute("id", "stream" + n.id),
            n.audio.setAttribute("style", "width: 100%; height: 100%; position: absolute"),
            n.audio.setAttribute("autoplay", "autoplay"),
            e.stream.local && (n.audio.volume = 0),
            e.stream.local && (n.audio.volume = 0),
            void 0 !== n.elementID ? (n.destroy = function() {
                n.audio.pause(),
                n.parentNode.removeChild(n.div)
            }
            ,
            t = function() {
                n.bar.display()
            ...
            ,
            n.div = document.createElement("div"),
            n.div.setAttribute("id", "player_" + n.id),
            n.div.setAttribute("style", "width: 100%; height: 100%; position: relative; overflow: hidden;"),
            document.getElementById(n.elementID).appendChild(n.div),
            n.container = document.getElementById(n.elementID),
            n.parentNode = n.div.parentNode,
            n.div.appendChild(n.audio),
            n.bar = new s.default({
            ...
            e.stream.local ? n.div.onmouseover = i : n.div.onmouseover = t,
            n.div.onmouseout = i) : (n.destroy = function() {
                n.audio.pause(),
                n.parentNode.removeChild(n.audio)
            }
            ,
            document.body.appendChild(n.audio),
            n.parentNode = document.body),
            c.default.debug("Creating URL from stream " + n.stream),
            (0,
            u.isSafari)())
                n.audio.srcObject = n.stream;
            else {
                var o = window.URL || webkitURL;
                n.stream_url = o.createObjectURL(n.stream),
                n.audio.src = n.stream_url
            }
            return n
        };
        t.default = l
        ...
        var n = i(0)
          ...
          , r = function(e) {
            ...
            var n = function(t) {
                ...
                t = t.replace(i[0], n),
                o.default.debug("Set Video Bitrate - min:" + e.minVideoBW + " max:" + e.maxVideoBW)),
            ...
            return t.processSignalingMessage = function(e) {
                ...
                t.incomingMessage = o,
                "new" === t.state ? "OFFER" === o.messageType ? (i = {
                    sdp: o.sdp,
                    type: "offer"
                },
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(i)),
                t.state = "offer-received",
                t.markActionNeeded()) : t.error("Illegal message for this state: " + o.messageType + " in state " + t.state) : "offer-sent" === t.state ? "ANSWER" === o.messageType ? (i = {
                    sdp: o.sdp,
                    type: "answer"
                },
                i.sdp = n(i.sdp),
            ...
            t.sendMessage = function(e, i) {
                ...
                n.messageType = e,
                n.sdp = i,
                "OFFER" === e ? (n.offererSessionId = t.sessionId,
                n.answererSessionId = t.otherSessionId,
                n.seq = t.sequenceNumber += 1,
                n.tiebreaker = Math.floor(429496723 * Math.random() + 1)) : (n.offererSessionId = t.incomingMessage.offererSessionId,
        ...
        var n = i(0)
          ...
          , r = function(e) {
            ...
            t.peerConnection.onicecandidate = function(e) {
                ...
                t.iceCandidateCount = t.iceCandidateCount + 1) : (o.default.debug("PeerConnection State: " + t.peerConnection.iceGatheringState),
            ...
            t.getStats = function(e) {
                t.peerConnection.getStats(null, function(i) {
                    ...
                    Object.keys(i).forEach(function(e) {
                        var t = i[e];
                        o.push(t),
                        "ssrc" !== t.type && "VideoBwe" !== t.type || (r = t.timestamp,
                        n.push(t))
                    }),
                    n.push({
                        id: "time",
        ...
        var n = i(0)
          ...
          , r = function(e) {
            ...
            t.peerConnection.onicecandidate = function(i) {
                ...
                i.candidate ? (0 === t.iceCandidateCount && (t.timeout = setTimeout(function() {
                    t.moreIceComing && (t.moreIceComing = !1,
                    t.markActionNeeded())
                }, 1e3)),
                t.iceCandidateCount = t.iceCandidateCount + 1) : (o.default.debug("PeerConnection State: " + t.peerConnection.iceGatheringState),
            ...
            t.processSignalingMessage = function(e) {
                ...
                t.incomingMessage = r,
                "new" === t.state ? "OFFER" === r.messageType ? (o = {
                    sdp: r.sdp,
                    type: "offer"
                },
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(o)),
                t.state = "offer-received",
                t.markActionNeeded()) : t.error("Illegal message for this state: " + r.messageType + " in state " + t.state) : "offer-sent" === t.state ? "ANSWER" === r.messageType ? (o = {
                    sdp: r.sdp,
                    type: "answer"
                },
                o.sdp = i(o.sdp),
                ...
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(o)),
                t.sendOK(),
                t.state = "established") : "pr-answer" === r.messageType ? (o = {
                    sdp: r.sdp,
                    type: "pr-answer"
                },
            ...
            return t.getStatsRate = function(e) {
                t.getStats(function(t) {
                    t.forEach(function(e) {
                        "outbound-rtp" === e.type && "video" === e.mediaType && e.googFramesEncoded && (e.googFrameRateSent = ((e.googFramesEncoded - u) / 3).toString(),
                        u = e.googFramesEncoded),
                        "inbound-rtp" === e.type && -1 != e.id.indexOf("55543") && (e.googFrameRateReceived && (e.googFrameRateReceived = ((e.googFrameReceived - p) / 3).toString(),
                        p = e.googFrameReceived),
                        e.googFrameRateDecoded && (e.googFrameRateDecoded = ((e.googFramesDecoded - l) / 3).toString(),
            ...
            t.getStats = function(e) {
                ...
                t.peerConnection.getStats().then(function(n) {
                    n.forEach(function(e) {
                        i.push(e),
                        "outbound-rtp" === e.type && "audio" === e.mediaType && (r.id = e.id,
                        r.type = e.type,
                        r.mediaType = e.mediaType,
                        r.bytesSent = e.bytesSent.toString(),
                        r.packetsSent = e.packetsSent.toString()),
                        "outbound-rtp" === e.type && "video" === e.mediaType && (a.id = e.id,
                        a.type = e.type,
                        a.mediaType = e.mediaType,
                        a.bytesSent = e.bytesSent.toString(),
                        a.packetsSent = e.packetsSent.toString(),
                        a.googPlisReceived = e.pliCount.toString(),
                        a.googNacksReceived = e.nackCount.toString(),
                        a.googFirsReceived = e.firCount.toString(),
                        a.googFramesEncoded = e.framesEncoded.toString()),
                        "inbound-rtp" === e.type && -1 != e.id.indexOf("44444") && (s.id = e.id,
                        s.type = e.type,
                        s.mediaType = "audio",
                        s.packetsReceived = e.packetsReceived.toString(),
                        s.bytesReceived = e.bytesReceived.toString(),
                        s.packetsLost = e.packetsLost.toString(),
                        s.packetsReceived = e.packetsReceived.toString(),
                        s.googJitterReceived = e.jitter.toString()),
                        "inbound-rtp" === e.type && -1 != e.id.indexOf("55543") && (d.id = e.id,
                        d.type = e.type,
                        d.mediaType = "video",
                        d.packetsReceived = e.packetsReceived.toString(),
                        d.bytesReceived = e.bytesReceived.toString(),
                        d.packetsLost = e.packetsLost.toString(),
                        d.googJitterBufferMs = e.jitter.toString(),
                        d.googNacksSent = e.nackCount.toString(),
                        d.googPlisSent = e.pliCount.toString(),
                        d.googFirsSent = e.firCount.toString()),
                        "track" === e.type && -1 != e.id.indexOf("55543") && (d.googFrameWidthReceived = e.frameWidth.toString(),
                        d.googFrameHeightReceived = e.frameHeight.toString(),
                        d.googFrameReceived = e.framesReceived.toString(),
                        d.googFramesDecoded = e.framesDecoded.toString()),
                        "track" === e.type && -1 != e.id.indexOf("44444") && (s.audioOutputLevel = e.audioLevel + "",
                ...
                if (t.actionNeeded) {
                    if ("new" === t.state || "established" === t.state) {
                        ...
                        t.peerConnection.createOffer(t.mediaConstraints).then(function(i) {
                            if (i.sdp = n(i.sdp),
                            e.isSubscriber || (i.sdp = i.sdp.replace(/a=extmap:4 urn:3gpp:video-orientation\r\n/g, "")),
                            i.sdp !== t.prevOffer)
                                return t.peerConnection.setLocalDescription(i),
                                t.state = "preparing-offer",
                                void t.markActionNeeded();
                            o.default.debug("Not sending a new offer")
                        }).catch(function(e) {
        ...
        var n = i(0)
          ...
          , r = function(e) {
            ...
            t.processSignalingMessage = function(e) {
                ...
                t.incomingMessage = r,
                "new" === t.state ? "OFFER" === r.messageType ? (r.sdp = u(r.sdp),
                n = {
                    sdp: r.sdp,
                    type: "offer"
                },
                ...
                t.state = "offer-received",
                t.markActionNeeded()) : t.error("Illegal message for this state: " + r.messageType + " in state " + t.state) : "offer-sent" === t.state ? "ANSWER" === r.messageType ? (r.sdp = u(r.sdp),
                r.sdp = r.sdp.replace(/ generation 0/g, ""),
                r.sdp = r.sdp.replace(/ udp /g, " UDP "),
                r.sdp = r.sdp.replace(/a=group:BUNDLE audio video/, "a=group:BUNDLE sdparta_0 sdparta_1"),
            ...
            t.getStatsRate = function(e) {
                t.getStats(function(t) {
                    t.forEach(function(e) {
                        "inboundrtp" === e.type && "video" === e.mediaType && e.googFrameRateDecoded && (e.googFrameRateDecoded = ((e.googFramesDecoded - c) / 3).toString(),
            ...
            t.getStats = function(e) {
                t.peerConnection.getStats().then(function(i) {
                    ...
                    Object.keys(i).forEach(function(e) {
                        var t = i[e];
                        n.push(t),
                        "outboundrtp" === t.type && "video" === t.mediaType && (a.id = t.id,
                        a.type = t.type,
                        a.mediaType = t.mediaType,
                        a.bytesSent = t.bytesSent.toString(),
                        a.packetsSent = t.packetsSent.toString(),
                        a.googPlisReceived = t.pliCount.toString(),
                        a.googNacksReceived = t.nackCount.toString(),
                        a.googFirsReceived = t.firCount.toString(),
                        a.googFrameRateSent = t.framerateMean.toString()),
                        "outboundrtp" === t.type && "audio" === t.mediaType && (r.id = t.id,
                        r.type = t.type,
                        r.mediaType = t.mediaType,
                        r.bytesSent = t.bytesSent.toString(),
                        r.packetsSent = t.packetsSent.toString()),
                        "inboundrtp" !== t.type || "audio" !== t.mediaType || t.isRemote || (s.id = t.id,
                        s.type = t.type,
                        s.mediaType = t.mediaType,
                        s.bytesReceived = t.bytesReceived.toString(),
                        s.packetsLost = t.packetsLost.toString(),
                        s.packetsReceived = t.packetsReceived.toString(),
                        s.googJitterReceived = t.jitter.toString()),
                        "inboundrtp" !== t.type || "video" !== t.mediaType || t.isRemote || (d.id = t.id,
                        d.type = t.type,
                        d.mediaType = t.mediaType,
                        d.bytesReceived = t.bytesReceived.toString(),
                        d.googFrameRateReceived = t.framerateMean.toString(),
                        d.googFramesDecoded = t.framesDecoded.toString(),
                        d.packetsLost = t.packetsLost.toString(),
                        d.packetsReceived = t.packetsReceived.toString(),
                        d.googJitterBufferMs = t.jitter.toString(),
                        d.googNacksSent = t.nackCount.toString(),
                        d.googPlisSent = t.pliCount.toString(),
                        d.googFirsSent = t.firCount.toString()),
                        -1 !== t.id.indexOf("outbound_rtcp_video") && (a.packetsLost = t.packetsLost.toString())
                    });
                    var o = [a, r, s, d];
                    o.push({
                        id: "time",
    ...
    , , function(e, t, i) {
        ...
        t.publishStatsFilter = n,
        t.subscribeStatsFilter = o
    }
    , function(e, t, i) {
        "use strict";
        function n(e) {
        ...
        var o = i(29)
          ...
          , v = function(e) {
                ...
                g.getDevices)(function(n) {
                    ...
                    try {
                        for (var s, d = n[Symbol.iterator](); !(o = (s = d.next()).done); o = !0) {
                            var c = s.value;
                            if (c.label === e && "videoinput" === c.kind)
                                return t(c.deviceId)
                        }
                    } catch (e) {
                        r = !0,
            ...
            t.enableDualStream = function(i, n) {
                if ("iOS" === (0,
                f.getBrowserOS)())
                    return p.report.streamSwitch(e.sessionId, {
                ...
                t.isDualStream = !0,
                0 === t.highStreamState ? t._publishLowStream(i, n) : 1 === t.highStreamState ? n && n(c.default.STILL_ON_PUBLISHING) : i && i()
            }
            ,
            t.disableDualStream = function(i, n) {
                ...
                t.isDualStream = !1,
                0 === t.highStreamState ? t._unpublishLowStream(i, n) : 1 === t.highStreamState ? n && n(c.default.STILL_ON_PUBLISHING) : i && i()
            }
            ,
            t._createLowStream = function(e, i) {
                if (!t.highStream || !t.highStream.stream)
                    return s.default.warning("Can't create low-stream without highStream");
                var n = Object.assign({}, t.highStream.params);
                if (n.streamID += 1,
                n.audio = !1,
                n.video) {
                    var o = t.highStream.stream.getVideoTracks()[0];
                    o || i("can not get hight-stream video track"),
            ...
            t._publishLowStream = function(e, i) {
                return 2 !== t.lowStreamState ? (s.default.warning("Can't publish low-stream when low-stream already publish"),
                i && i()) : t.highStream && t.highStream.hasScreen() ? i && i(c.default.SHARING_SCREEN_NOT_SUPPORT) : void t._getLowStream(function(n) {
                    t.lowStreamState = 1,
            ...
            t._unpublishLowStream = function(e, i) {
                if (0 !== t.lowStreamState)
                    return s.default.warning("Can't unpublish low-stream when low-stream not ever publish"),
                    i && i();
                t.lowStream && (t.lowStreamState = 1,
                t.gatewayClient.unpublish(t.lowStream, function() {
                    t.lowStream.close(),
                    t.lowStream = null,
                    t.lowStreamState = 2,
                    e && e()
            ...
            t.join = function(i, n, o, r, a) {
                ...
                l.getGatewayList)(d, function(o) {
                    ...
                    t.gatewayClient.join(d, t.key, function(e) {
                        s.default.info("Join channal " + n + " success"),
                        r(e)
                    }, a)
                }, a)
            }
            ...
            t.renewChannelKey = function(e, i, n) {
                void 0 === t.key && ((0,
                u.safeCall)(n, c.default.INVALID_OPERATION),
            ...
            ,
            t.publish = function(i, n) {
                if (2 !== t.highStreamState)
                    return s.default.warning("Can't publish stream when stream already publish", i.getId()),
                    n && n("stream already publish");
                ...
                t.gatewayClient.publish(i, function() {
                    ...
                    t.isDualStream && t._publishLowStream(null, n)
                }, n)
            }
            ,
            t.unpublish = function(e, i) {
                if (0 !== t.highStreamState)
                    ...
                    i && i("stream not publish");
                s.default.info("Unpublish stream, uid: ", e.getId()),
                t.isDualStream && t.lowStream ? t._unpublishLowStream(function() {
                    t.highStreamState = 1,
                    t.gatewayClient.unpublish(e, function() {
                        t.highStreamState = 2,
                        s.default.info("Unpublish stream success, uid:", e.getId())
                    }, i)
                }, i) : (t.highStreamState = 1,
                t.gatewayClient.unpublish(e, function() {
                    t.highStreamState = 2,
                    s.default.info("Unpublish stream success, uid:", e.getId())
                }, i))
            ...
            t.setLiveTranscoding = function(e) {
                Object.assign(_, e),
                t.gatewayClient.setLiveTranscoding(_)
            }
            ,
            t.gatewayClient = (0,
            r.default)(e),
          ...
          , h = function(e) {
            return e && "interop" === e.mode ? (s.default.info("Creating client , MODE : Interop"),
            v({
                mode: "live"
            })) : e && "h264_interop" === e.mode ? (s.default.info("Creating client , MODE : h264_interop"),
            v({
                mode: "live",
                codec: "h264"
            })) : (s.default.info("Creating client , MODE : web-only"),
            v({
                mode: "rtc"
            }))
        }
    ...
    , function(e, t, i) {
        ...
        : function(e) {
          ...
          , E = function(e) {
            ...
            k.p2p_attemps = 1,
            k.audioLevel = {},
            k.activeSpeaker = void 0,
            k.firstFrameTimer = new Map,
            k.liveStreams = new Map;
            var M = g.default;
            ...
            k.join = function(e, t, i, o) {
                var r = (new Date).getTime()
                  , s = e.uid;
                return 0 !== k.state ? (o && o(f.default.INVALID_OPERATION),
                ...
                void l.default.error("Server already in connecting/connected state")) : null !== s && void 0 !== s && parseInt(s) !== s ? (o && o(f.default.INVALID_PARAMETER),
                _.report.joinGateway(e.sid, {
                    lts: r,
                    succ: !1,
                ...
                void l.default.error("Input uid is invalid")) : (k.joinInfo = e,
                k.uid = s,
                k.key = t,
                k.state = 1,
                void U(e, function(t) {
                    k.stunServerUrl = t.stunServerUrl,
                    k.turnServer = t.turnServer,
                    k.state = 2,
                    l.default.debug("Connected to gateway server"),
                    k.pingTimer = setInterval(function() {
                        x(n(), function() {}, function(e) {})
                    }, 3e3),
                    x(a(), function(t) {
                        _.report.joinGateway(e.sid, {
                            lts: r,
            ...
            k.leave = function(e, i) {
                ...
                for (var n in k.timers)
                    k.timers.hasOwnProperty(n) && clearInterval(k.timers[n]);
                x(u(), function(t) {
                    k.socket.close(),
                    k.socket = void 0,
                ...
                for (var n in k.localStreams)
                    if (k.localStreams.hasOwnProperty(n)) {
                        ...
                        delete k.localStreams[n],
                        void 0 !== o.pc && (o.pc.close(),
                        o.pc = void 0)
                    }
                t(),
                k.state = 0
            ...
            k.publish = function(e, t, i) {
                ...
                "object" !== (void 0 === e ? "undefined" : o(e)) || null === e)
                    ...
                    void _.report.publish(k.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                ...
                e.local && void 0 === k.localStreams[e.getId()] && (e.hasAudio() || e.hasVideo() || e.hasScreen()) && (void 0 !== e.url ? B(A({
                    state: "url",
                    audio: e.hasAudio(),
                    video: e.hasVideo(),
                    ...
                    callback: function(o) {
                        ...
                        B(A({
                            ...
                            e.pc.onsignalingmessage = function(t) {
                                ...
                                ,
                                l.default.info("Local stream published with uid", a.id),
                                e.onClose = function() {
                                    k.unpublish(e)
                                }
                                ,
                            ...
                            ,
                            l.default.debug("SDP exchange in publish : receive answer --  ", JSON.parse(r)),
                ...
                k.timers[e.getId()] = setInterval(function() {
                    e && e.pc && e.pc.getStats && e.pc.getStatsRate(function(t) {
                        t.forEach(function(t) {
                            ...
                            e.getUserId && (e.getId() === e.getUserId() ? x(w(t), null, null) : x(C(t), null, null))
                        })
                    })
                }, 3e3),
            ...
            k.unpublish = function(e, t, i) {
                return "object" !== (void 0 === e ? "undefined" : o(e)) || null === e ? (M(i, f.default.INVALID_LOCAL_STREAM),
                void l.default.error("Invalid local stream")) : 2 !== k.state ? (M(i, f.default.INVALID_OPERATION),
                void l.default.error("User not in the session")) : (void 0 != k.timers[e.getId()] && clearInterval(k.timers[e.getId()]),
                void (void 0 !== k.socket ? e.local && void 0 !== k.localStreams[e.getId()] ? (delete k.localStreams[e.getId()],
                x(I(e.getUserId()), function(n) {
                    if ("error" === n)
                        return M(i, f.default.UNPUBLISH_STREAM_FAILED),
                        void l.default.error("Unpublish stream failed");
                    ...
                    e.muteVideo = void 0,
                    t && t()
                }, i)) : (M(i, f.default.INVALID_LOCAL_STREAM),
                l.default.error("Invalid local stream")) : (M(i, f.default.INVALID_OPERATION),
                l.default.error("User not in the session"))))
            }
            ,
            k.subscribe = function(e, t) {
                var i = (new Date).getTime();
                return e.subscribeLTS = i,
                "object" !== (void 0 === e ? "undefined" : o(e)) || null === e ? (t && t(f.default.INVALID_REMOTE_STREAM),
                ...
                void l.default.error("Invalid remote stream")) : 2 !== k.state ? (t && t(f.default.INVALID_OPERATION),
                _.report.subscribe(k.joinInfo.sid, {
                    lts: i,
                    succ: !1,
                    peerid: e.getId() + "",
                ...
                void l.default.error("User is not in the session")) : void (!e.local && k.remoteStreams.hasOwnProperty(e.getId()) && (e.hasAudio() || e.hasVideo() || e.hasScreen()) ? (e.pc = (0,
                d.Connection)({
                    callback: function(t) {
                ...
                e.pc.onaddstream = function(t, i) {
                    if ("ontrack" === i && "video" === t.track.kind || "onaddstream" === i) {
                        ...
                        k.remoteStreams[e.getId()].stream = "onaddstream" === i ? t.stream : t.streams[0],
                        k.remoteStreams[e.getId()].hasVideo()) {
                            if ((0,
                            b.isFireFox)()) {
                                var n = k.remoteStreams[e.getId()].stream;
                                (0,
                                h.vsResHack)(n, function(t, i) {
                                    e.videoWidth = t,
                                    e.videoHeight = i
                                }, function(e) {
                            ...
                            k.remoteStreams[e.getId()].disableVideo();
                        var o = (0,
                        c.StreamEvent)({
                ...
                k.timers[e.getId()] = setInterval(function() {
                    e && e.pc && e.pc.getStats && e.pc.getStatsRate(function(t) {
                        t.forEach(function(t) {
                            ...
                            B(T(e.getId(), t), null, null)
                        })
                    })
                }, 3e3),
                k.audioLevel[e.getId()] = 0,
                k.timers[e.getId() + "audio"] = setInterval(function() {
                        ...
                        t.forEach(function(t) {
                            if ("audio" === t.mediaType) {
                                if (t.audioOutputLevel > 5e3) {
                                    ...
                                    for (var i in k.audioLevel)
                                        parseInt(i) !== e.getId() && k.audioLevel[i] > 0 && (k.audioLevel[i] -= 1)
                                }
                                ...
                                if (k.activeSpeaker !== o[0]) {
                                    ...
                                    k.dispatchEvent(r),
                                    k.activeSpeaker = o[0],
                                    l.default.debug("Update active speaker:" + k.activeSpeaker)
                                }
                            }
                        })
                    })
                ...
                e.pc.oniceconnectionstatechange = function(n) {
                    "failed" === n ? (void 0 != k.timers[e.getId()] && (clearInterval(k.timers[e.getId()]),
                    clearInterval(k.timers[e.getId()] + "audio")),
                    x(E(), function() {}, function() {}),
                    k.socket.disconnect(),
                    l.default.error("Subscriber connection is lost", e.getId()),
                    t && t(f.default.PEERCONNECTION_FAILED),
                    _.report.subscribe(k.joinInfo.sid, {
                        lts: i,
                        succ: !1,
                        peerid: e.getId() + "",
                        ec: f.default.PEERCONNECTION_FAILED
                    })) : "connected" === n && (_.report.subscribe(k.joinInfo.sid, {
                        lts: i,
                        succ: !0,
                        peerid: e.getId() + "",
                        ec: null
                    }),
                    k.firstFrameTimer.set(e.getId(), setInterval(function() {
                        e.pc ? e.pc.getStats(function(t) {
                            t.forEach(function(t) {
                                -1 === t.id.indexOf("recv") && -1 === t.id.indexOf("inbound_rtp") && -1 === t.id.indexOf("InboundRTP") || "video" === t.mediaType && (t.framesDecoded > 0 || t.googFramesDecoded > 0) && (clearInterval(k.firstFrameTimer.get(e.getId())),
                                k.firstFrameTimer.delete(e.getId()),
                                _.report.firstRemoteFrame(k.joinInfo.sid, {
                                    lts: (new Date).getTime(),
                                    peerid: e.getId() + "",
                                    succ: !0,
                        ...
                        }) : (clearInterval(k.firstFrameTimer.get(e.getId())),
                        k.firstFrameTimer.delete(e.getId()))
                    }, 100)))
                }
                ) : (t && t(f.default.INVALID_REMOTE_STREAM),
                _.report.subscribe(k.joinInfo.sid, {
                    lts: i,
                    succ: !1,
                    peerid: e.getId() + "",
            ...
            k.unsubscribe = function(e, t) {
                return "object" !== (void 0 === e ? "undefined" : o(e)) || null === e ? (M(t, f.default.INVALID_REMOTE_STREAM),
                void l.default.error("Invalid remote stream")) : 2 !== k.state ? (M(t, f.default.INVALID_OPERATION),
                void l.default.error("User is not in the session")) : (void 0 != k.timers[e.getId()] && (clearInterval(k.timers[e.getId()]),
                clearInterval(k.timers[e.getId()] + "audio")),
                void 0 != k.audioLevel[e.getId()] && delete k.audioLevel[e.getId()],
                void 0 != k.timer_counter[e.getId()] && delete k.timer_counter[e.getId()],
                k.remoteStreams.hasOwnProperty(e.getId()) ? k.socket ? e.local ? (M(t, f.default.INVALID_REMOTE_STREAM),
                void l.default.error("Invalid remote stream")) : (e.close(),
                delete k.remoteStreams[e.getId()],
                void x(R(e.getId()), function(i) {
                    if ("error" === i)
                        return M(t, f.default.UNSUBSCRIBE_STREAM_FAILED),
                        void l.default.error("Unsubscribe remote stream failed", e.getId());
                    l.default.info("Unsubscrib stream success")
                }, t)) : (M(t, f.default.INVALID_OPERATION),
                void l.default.error("User is not in the session")) : void M(t, f.default.NO_SUCH_REMOTE_STREAM))
            }
            ,
            k.setRemoteVideoStreamType = function(e, t) {
                ...
                if (!e.local) {
                    ...
                    x(y(e.getId(), t), null, null)
                }
            }
            ,
            k.startLiveStreaming = function(e, t) {
                if (k.liveStreams.set(e, t),
            ...
            var V = function(e) {
              ...
              , P = function() {
                k.key ? (l.default.info("Re-joining to channel " + k.joinInfo.cname),
                k.join(k.joinInfo, k.key, function(e) {
                    ...
                    k.liveStreams && k.liveStreams.size && k.liveStreams.forEach(function(e, t) {
                        e && k.setLiveTranscoding(k.transcoding),
                        k.startLiveStreaming(t, e)
                    })
                }, function(e) {
                    if (l.default.error("Re-join to channel failed [" + e + "]"),
                    e === f.default.ERR_INVALID_VENDOR_KEY) {
                        var t = (0,
                        c.StreamEvent)({
                            type: "error",
                        ...
                        setTimeout(function() {
                            k.attemps++,
                            void 0 !== k.socket && k.socket.disconnect()
                        }, i)
                    }
              ...
              , U = function(e, n, o) {
                void 0 !== k.socket ? k.socket.socket.connect() : (F(e.gatewayAddr),
                k.socket.on("onUplinkStats", function(e) {
                ...
                k.socket.on("reconnect", function() {
                    ...
                    (0,
                    v.getGatewayList)(k.joinInfo, function(e) {
                ...
                k.socket.on("onAddVideoStream", function(e) {
                    ...
                    void 0 === k.remoteStreams[e.id]) {
                        ...
                        k.remoteStreams[e.id].video = !0,
                        k.remoteStreams[e.id].enableVideo(),
                ...
                k.socket.on("onPeerLeave", function(e) {
                    ...
                    if (k.remoteStreams.hasOwnProperty(e.id) && (t.stream = k.remoteStreams[e.id]),
                    k.dispatchEvent(t),
                    k.remoteStreams.hasOwnProperty(e.id)) {
                    ...
                    k.timers.hasOwnProperty(e.id) && (clearInterval(k.timers[e.id]),
                    delete k.timers[e.id]),
                    void 0 != k.audioLevel[e.id] && delete k.audioLevel[e.id],
                    void 0 != k.timer_counter[e.id] && delete k.timer_counter[e.id]
                }),
                k.socket.on("onUplinkStats", function(e) {}),
                k.socket.on("liveStreamingStarted", function(e) {
                    var t = (0,
              ...
              , x = function(e, t, i) {
                if (void 0 === k.socket)
                    return M(i, f.default.INVALID_OPERATION),
                    void l.default.error("No socket available");
                try {
                    k.socket.emitSimpleMessage(e, function(e, n) {
                        "success" === e ? "function" == typeof t && t(n) : "function" == typeof i && i(n)
                    })
                } catch (t) {
                    M(i, f.default.SOCKET_ERROR),
          ...
          , u = function(e) {
            ...
            t.creatConnection = function() {
                if (t.hostIndex >= t.host.length)
                    return t.hostIndex = 0,
                    void t.dispatchEvent((0,
                    o.MediaEvent)({
                        type: "reconnect"
                    }));
                d.default.debug("start connect:" + t.host[t.hostIndex]),
                t.lts = (new Date).getTime(),
                t.connection = new WebSocket("wss://webgw-test-5.agora.io:5866"),
                t.hostIndex++,
                ...
                t.connection.onmessage = function(e) {
                    ...
                    i.hasOwnProperty("_id") ? t.dispatchEvent((0,
                    o.MediaEvent)({
                        type: i._id,
                        msg: i
                    })) : i.hasOwnProperty("_type") && t.dispatchSocketEvent((0,
                    o.MediaEvent)({
                        type: i._type,
                        msg: i.message
                    }))
                ...
                t.connection.onclose = function(i) {
                    ...
                    t.creatConnection()) : t.dispatchEvent((0,
                    o.MediaEvent)({
                        type: "disconnect",
                        event: i
                    })) : (d.default.debug("websockect closeed"),
                    (0,
                    a.default)(e.onFailure, i),
                    clearTimeout(t.timeoutCheck),
                    t.dispatchEvent((0,
                    o.MediaEvent)({
                        type: "close",
            ...
            t.sendSignalCommand = function(e, i) {
                ...
                t.requestID += 1,
                "publish_stats" !== e._type && "subscribe_stats" !== e._type && "publish_stats_low" !== e._type && t.on(e._id, function(n) {
                    i && i(n.msg._result, n.msg.message),
    ...
    , function(e, t, i) {
        ...
        var n = i(3)
          , o = function(e) {
            ...
            return (0,
            n.isFireFox)() ? [t[1], 30, 100] : (0,
            n.isSafari)() ? [t[2], 15, 100] : [t[0], 15, 100]
        };
        t.simMap = o
    }
    , , function(e, t, i) {
        ...
        t.AUDIO_SAMPLE_RATE_32000 = n.AUDIO_SAMPLE_RATE_32000,
        t.AUDIO_SAMPLE_RATE_44100 = n.AUDIO_SAMPLE_RATE_44100,
        t.AUDIO_SAMPLE_RATE_48000 = n.AUDIO_SAMPLE_RATE_48000,
        t.VIDEO_CODEC_PROFILE_BASELINE = n.VIDEO_CODEC_PROFILE_BASELINE,
        t.VIDEO_CODEC_PROFILE_MAIN = n.VIDEO_CODEC_PROFILE_MAIN,
        t.VIDEO_CODEC_PROFILE_HIGH = n.VIDEO_CODEC_PROFILE_HIGH,
        t.TranscodingUser = n.TranscodingUser,
        t.LiveTranscoding = n.LiveTranscoding,
        t.createClient = n.createClient,
        t.createStream = o.createStream,
        t.getDevices = o.getDevices,
